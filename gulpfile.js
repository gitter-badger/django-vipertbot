...
gulp.task('vendorJS', function() {
    return gulp.src([
            ...
            smart_js_plugin_path + '/flot/jquery.flot.fillbetween.min.js',
            smart_js_plugin_path + '/flot/jquery.flot.orderBar.min.js',
            smart_js_plugin_path + '/flot/jquery.flot.pie.min.js',
